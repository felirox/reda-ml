...
check_words = ["hello radar","hi", "hello","hello Radhika","hi radar","hello Radha","hey Radhika","hey radar","heda","Irada","Prada","hello hello", ]
                    ...
                    if(suslink == 1):
                        if(pscintentt == "Suspect - getname"):
                            ...
                            if(cco ==4):
                                ...
                                #r = requests.post('https://reda.niran.dev/remote_sql.php?suspected_name='+'papamaria '+man+'&address='+adu+'&symptoms='+simp+'&suspected_age='+agg+'&reported_date='+date1)
                                #print (r)
                                uneurl = str('https://reda.niran.dev/remote_sql.php?suspected_name='+'papamaria'+man+'&address='+adu+'&symptoms='+simp+'&suspected_age='+agg+'&reported_date='+date1)
                                finur = quote(uneurl,safe=':,/,?,=,&,-,_')
                                #finur.replace(" ","%20")
                                print(finur)
                                urlop = urllib.request.urlopen(finur)
                                print(urlop.read())
